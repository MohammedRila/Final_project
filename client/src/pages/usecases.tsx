      ...
      <main className="flex-grow pt-20">
        <section className="py-16 bg-gradient-to-b from-primary-50 to-white">
          <div className="container mx-auto px-4">
            <h1 className="font-heading text-4xl font-bold text-center text-primary-800 mb-6">PhishHook AI Use Cases</h1>
            <p className="text-center text-neutral-700 max-w-3xl mx-auto mb-12">
              Our phishing detection tool can be applied in multiple scenarios to protect individuals and organizations from various types of phishing attacks.
            </p>
              ...
              {useCaseItems.map((item, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mb-4">
                    <i className={`fas fa-${item.icon} text-primary-600`}></i>
                  </div>
            ...
            <div className="mt-16 text-center">
              <h2 className="font-heading text-2xl font-bold text-primary-800 mb-4">Ready to protect yourself?</h2>
